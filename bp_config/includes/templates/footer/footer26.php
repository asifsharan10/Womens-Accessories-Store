<footer class="footer footer26 footer-background-color" id="footer">
   <div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-lg-12 brand-main">
      ...
      <div class="col-lg-12 col-sm-6 footer-links">
       ...
       <div class="quick-links">
        ...
        <div class="footer-links quick-links m-0 my-4">
        <div class="mb-5 mb-md-0"> 
          <!--Title-->
          <h5>Legal</h5>
          <div class="spacer"></div>
      ...
      <div class="col-lg-12 col-sm-6 footer-links">
        <div class="mb-5 mb-md-0"> 
          ...
          <ul class="contact-widget">
            <li class="d-flex"> 
              <div class="info mb-3"><i class="fas fa-map-marker-alt me-2"></i> <?= $generalConfig['address'] ?></div>
            </li>
            <li class="d-flex"> 
              <div class="info  mb-3"><i class="fas fa-phone-alt me-2"></i> <?= $generalConfig['phone_number'] ?></div>
            </li>
            <li class="d-flex">
              <div class="info"><i class="fas fa-envelope me-2"></i> <a href="mailto:<?= $generalConfig['email'] ?>"  style="word-break: break-all;"><?= $generalConfig['email'] ?></a></div>
            </li>
          </ul>
          <!--Contact--> 
        </div>
        ...
        <!--Contact Block-->
      <div class="footer-links m-0 my-4">
        <div class="mb-5 mb-md-0"> 
          <!--Title-->
          <h5>Returns</h5>
          <div class="spacer"></div>
  ...
  <div class="copyright">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 date-contain">
          <p>
            &copy; <?php echo date("Y"); ?> <?= $generalConfig['brand_name'] ?>
          </p>
        </div>
        <div class="col-lg-6 corp-contain">
          <div class="corp">
