<footer class="footer footer29 footer-background-color pt-0" id="footer">
   <div class="container">
    <div class="w-100 footer-brand-name row">
        <!--Title-->
        <div class="col-lg-6 d-flex align-items-center px-4">
        <div class="container bottom-footer p-0">
            <p class="main-top-left">&copy; <?php echo date("Y"); ?> <?= $generalConfig['brand_name'] ?></p>    
            <div class="corp">
        ...
        <div class="col-lg-6 d-flex align-items-center px-4">
        <p class="w-100 brand-name main-top-right"><?= $generalConfig['brand_name'] ?></p>
        </div>   
    </div>
  ...
  <div class="col-lg-12">
    <div class="mb-md-0 copyright">
        <div class="footer-cc text-center">
