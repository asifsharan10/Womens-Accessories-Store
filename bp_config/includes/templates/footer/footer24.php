...
<footer class="footer footer24 footer-background-color" id="footer">
   <div class="container">
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-lg-3 col-sm-6 footer-links contact-details">
        <div class="mb-5 mb-md-0"> 
          <!--Title-->
      ...
      <div class="col-lg-3 col-sm-6 footer-links quick-links">
        <div class="mb-5 mb-md-0"> 
          <!--Title-->
          <h5>Legal</h5>
          <div class="spacer"></div>
