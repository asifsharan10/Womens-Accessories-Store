...
<footer class="footer2 footer-background-color"  id="footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="mb-5 mb-md-0"> 
          ...
          <!--Contact-->
          <ul class="contact-widget">
            <li class="d-flex"> <span class="material-icons  me-2"> phone_iphone </span>
              <div class="info"> <?= $generalConfig['phone_number'] ?></div>
            </li>
            <li class="d-flex"> <span class="material-icons me-2 "> mail </span>
              <div class="info"  style="word-break: break-all;"> <?= $generalConfig['email'] ?></div>
            </li>
            <li class="d-flex"> <span class="material-icons  me-2 "> place </span>
