<footer class="footer footer22 footer-background-color" id="footer">
   <div class="px-5">
    ...
    <div class="row">
        ...
        <div class="mb-5 mb-md-0"> 
          ...
          <h5 class="my-4 brand-name"><?= $generalConfig['brand_name'] ?></h5>
          <!--/Title--> 
        </div>
      </div>
      <!--Contact Block-->
      ...
      <div class="row copyright bottom-footer mt-4 px-5">
        ...
        <ul class="row col-lg-6 contact-widget">
            <li class="col-lg-4 pb-2 my-2">
                <i class="fas fa-map fs-10 me-4"></i>
                <?= $generalConfig['address'] ?></li>
            <li class="col-lg-4 pb-2 my-2"><i class="fa fa-phone fs-10 me-4"></i> <a href="tel:<?= $generalConfig['phone_number'] ?>">
                <?= $generalConfig['phone_number'] ?>
                </a></li>
            <li class="col-lg-4 pb-2 my-2"><i class="fa fa-envelope  fs-10 me-4 "></i> <a href="mailto:<?= $generalConfig['email'] ?>" style="word-break: break-all;">
                <?= $generalConfig['email'] ?>
                </a></li>
        </ul>
      </div>
