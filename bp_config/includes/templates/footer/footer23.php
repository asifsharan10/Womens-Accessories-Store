<footer class="footer footer23 footer-background-color" id="footer">
   <div class="container">
    
    <div class="row contain">
      <div class="col-lg-12 product-categories">
        <?php
    ...
    <div class="row contain mt-4">
      <div class="col-lg-5 col-sm-6 footer-links">
    ...
    <div class="row contain my-5">
        <div class="col-lg-10 mb-lg-0"> 
          <!--Title-->
          <h5 class="text-center"> About us</h5>
          <!--/Title-->
          <div class="footer-about">
            <p class="footer-brand text-center"><?= $generalConfig['brand_name'] ?></p>
          </div>
      </div>
    </div>
