<footer class="footer footer11 footer-background-color" id="footer">
   <div class="container">
    ...
    <div class="row">
      <!--Contact Block-->
      <div class="col-lg-4 col-sm-6 mt-4 footer-site-map">
      ...
      <div class="col-lg-4 col-sm-6 mt-4 footer-site-map">
        ...
        <!--Contact Block-->
      <div class="col-lg-4 col-sm-6 mt-4 footer-return-shipment">
        <div class="mb-5 mb-md-0"> 
          <!--Title-->
