                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="shippingState" id="shipping_state" class="form-control "
                                autocomplete="address-level1" data-placeholder="State / Province" data-input-classes=""
                                placeholder="State / Province" tabindex="-1" aria-hidden="true">
...
$(document).ready(function() {
    ...
    if (cartProducts) {
        ...
        $("#total-price").html("$ " + cartTotal.toFixed(2));
    }
});
</script>