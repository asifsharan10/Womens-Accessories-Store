                            ...
                            <div class="payment-wrapper">
                                ...
                                <div class="form-btn p-4">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-order" id="btnPlaceOrder">Place
                                            Order</button>
                                    </div>
                                </div>
                            </div>
